    ...
    <div className={`flex text-sm sm:text-xl ${darkMode ? 'bg-blur1': 'bg-blur2'} duration-600 text-white items-center justify-between pl-6 pr-6 pt-5 pb-5 border-b-[1px] border-[#5a626957]`}>
          ...
          <div className='flex gap-2 items-center'>
              ...
              <div className=" relative flex flex-col gap-2 items-center">
                ...
                {user ? (
                  <div className={` bg-[#3b3e42] z-10 rounded-md pt-2 pb-2 pl-2 pr-2 flex flex-col gap-2 absolute right-0.5 ${openLogInOut ? 'top-10 opacity-100 pointer-events-auto ' : ' top-5 opacity-0 pointer-events-none'} duration-300`}>
