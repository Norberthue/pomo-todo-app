...
const Boards = ({ addBoard, dataBoard, darkMode}: BoardsForms) => {
  ...
  return (
    <div className="flex flex-col sm:h-screen gap-20 ">
        <div className="flex gap-5 flex-col sm:flex-row justify-between items-center mx-24 mt-10">
          <div>
        ...
        <div className="flex justify-center  items-center text-white">
          <div className="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-4 gap-5 border-t-1  border-[#5a626957] pt-7">
            ...
            font-semibold cursor-pointer   flex items-center justify-center`}>
                ...
                <div className={`${openCreateBoard ? 'absolute': 'hidden'}  content-shadow  ${darkMode ? 'text-white bg-[#1d2125]  ' : 'text-gray-500 border-gray-200 bg-gray-50'}
                sm:-right-80 flex flex-col gap-5 p-2 rounded-lg max-h-[600px] h-[600px] max-w-[400px] w-full`}>
